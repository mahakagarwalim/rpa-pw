...
/** DB URI */
export const PRIMARY_DB_URI = SERVER_ENV === "PROD" && PROD_PRIMARY_DB_URI || TEST_PRIMARY_DB_URI;
export const SECONDARY_DB_URI = SERVER_ENV === "PROD" && PROD_SECONDARY_DB_URI || TEST_SECONDARY_DB_URI;;
